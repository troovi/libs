...
export const caseNIP = createCase('#NIP - Cannot remove owner-fallback entity', {
  execute: async (kit, dataSource) => {
    ...
    await dataSource.collections.chat.remove('chat-1')
  },
  expectations: {
    tables: {
    ...
    scheme: {
      ...
      shift: [
        mock.Shift({ shiftId: 10001, projectId: 1001, locationId: 'location-1', chatId: 'chat-1' })
      ]
    },
    error: new CoreError('Chat', {
