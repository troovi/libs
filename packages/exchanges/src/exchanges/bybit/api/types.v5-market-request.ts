import { ByBitDefenitions, KlineIntervalV3 } from './types'
...
export interface GetTickersParamsV5<TCategory = ByBitDefenitions.CategoryV5> {
  category: TCategory
  symbol?: string
  baseCoin?: string
  expDate?: string
...
export interface GetPublicTradingHistoryParamsV5 {
  ...
  symbol: string
  baseCoin?: string
  optionType?: ByBitDefenitions.OptionTypeV5
  limit?: number
}
