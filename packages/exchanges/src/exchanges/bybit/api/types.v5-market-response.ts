 ...
 */
export type OHLCVKlineV5 = [string, string, string, string, string, string, string]
/**
...
export interface LinearInverseInstrumentInfoV5 {
  symbol: string
  contractType: ByBitDefenitions.ContractTypeV5
  status: ByBitDefenitions.InstrumentStatusV5
  baseCoin: string
  quoteCoin: string
  launchTime: string
  deliveryTime?: string
  ...
  settleCoin: string
  copyTrading: ByBitDefenitions.CopyTradingV5
...
export interface OptionInstrumentInfoV5 {
  symbol: string
  optionsType: ByBitDefenitions.OptionTypeV5
  status: ByBitDefenitions.InstrumentStatusV5
  baseCoin: string
  quoteCoin: string
  settleCoin: string
...
export interface SpotInstrumentInfoV5 {
  ...
  innovation: '0' | '1'
  status: ByBitDefenitions.InstrumentStatusV5
  marginTrading: ByBitDefenitions.MarginTradingV5
  stTag: '0' | '1'
  lotSizeFilter: {
...
export interface CategoryCursorListV5<
  T extends unknown[],
  TCategory extends ByBitDefenitions.CategoryV5 = ByBitDefenitions.CategoryV5
> {
  category: TCategory
  list: T
...
export type InstrumentInfoResponseV5<C extends ByBitDefenitions.CategoryV5> = CategoryCursorListV5<
  InstrumentInfoV5Mapping[C],
  C
>
/**
 * [price, size]
...
export interface PublicTradeV5 {
  ...
  price: string
  size: string
  side: ByBitDefenitions.OrderSideV5
  time: string
